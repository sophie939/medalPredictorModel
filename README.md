...
When evaluating my model on the test data, it had high accuracy as it correctly classified 89.63% of test cases. However, a more meaningful metric would be the recal since the data set is imbalanced and the number of true positives (medal winners) is very low at only 10.8%. Recal measures the proportion of correctly classified medal winners out of all medal winners in the data, which is more important than understanding how many athletes don't medal.
